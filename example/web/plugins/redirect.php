...
elseif ('/login' === $q) {
  header("HTTP/1.1 301 Moved Permanently");
  header('Location: /plugins/redirect.php?q=#sm=login');
}
...
//
  ...
  switch ($q) {
    ...
    case '':
      ...
      header("Location: $base_url/plugins/redirect.php?q=/aliased-path");
      break;

    // Step 2
    case '/node/1':
      header("HTTP/1.1 302 Moved Permanently");
      header('Location: /plugins/redirect.php?q=/aliased-path');
      break;
